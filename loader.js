(function (window, document)
{
	...
	*/
	...
	let config        = document.currentScript ? document.currentScript.dataset : {},
		...
		url           = config['hljsUrl']   || 'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.17.0/build/';
