(function (window, document)
{
	...
	*/
	...
	let config        = document.currentScript.dataset,
		...
		url           = config['hljsUrl']   || 'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.6.0/build/';
