(function (window, document)
{
	...
	*/
	...
	let config        = document.currentScript.dataset,
		...
		url           = config['hljsUrl']   || 'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.4.1/build/';
