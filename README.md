...
```html
<script async src="https://cdn.jsdelivr.net/gh/s9e/hljs-loader@1.0.8/loader.min.js"
        crossorigin="anonymous"
        integrity="sha384-PG1zopchh98J/8eUG/5ESEA+dE1Art6Ym1XKxLljmoOwlodOfUguCC/cydPWZSQ/"></script>
```
