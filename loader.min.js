...
f.observe(a,{childList:!0,subtree:!0}))}}function D(a){a instanceof Element&&n(a)}function y(){m();p()}if(!e.hljsLoader){var z=d.currentScript,k=z.dataset,l=!1,g,t=z.nonce,h=k.hljsObserve,f,x=k.hljsOptions,v={"":1},w=k.hljsStyle||"default",r=k.hljsUrl||"https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.6.0/build/";"complete"===d.readyState?y():e.addEventListener("load",y);e.hljsLoader={disconnect:()=>{f&&f.disconnect();h=""},highlightBlocks:n,observe:a=>{h=a;p()}}}})(window,document);
