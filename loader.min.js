...
subtree:!0}))}}function E(a){a.forEach(F)}function F(a){a.addedNodes.length&&a.addedNodes.forEach(G)}function G(a){1===a.nodeType&&l(a)}function C(){k();p()}if(!f.hljsLoader){var h=b.currentScript?b.currentScript.dataset:{},z=!1,m,g=h.hljsObserve,d,B=h.hljsOptions,y={},A=h.hljsStyle||"default",r=h.hljsUrl||"https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.15.10/build/";"complete"===b.readyState?C():f.addEventListener("load",C);f.hljsLoader={disconnect:function(){d&&d.disconnect();g=""},highlightBlocks:l,
