...
function G(a){a.forEach(H)}function H(a){a.addedNodes.length&&a.addedNodes.forEach(I)}function I(a){1===a.nodeType&&m(a)}function D(){l();q()}if(!f.hljsLoader){var E=b.currentScript,k=E.dataset,A=!1,n,u=E.nonce,h=k.hljsObserve,d,C=k.hljsOptions,z={"":1},B=k.hljsStyle||"default",t=k.hljsUrl||"https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.2.0/build/";"complete"===b.readyState?D():f.addEventListener("load",D);f.hljsLoader={disconnect:function(){d&&d.disconnect();h=""},highlightBlocks:m,observe:function(a){h=
a;q()}}}})(window,document);
