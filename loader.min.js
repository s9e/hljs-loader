...
{h instanceof Element&&p(h)})})),f.observe(a,{childList:!0,subtree:!0}))}}function z(){n();q()}if(!e.hljsLoader){var A=d.currentScript,l=A.dataset,m=!1,g,u=A.nonce,k=l.hljsObserve,f,y=l.hljsOptions,w={"":1},x=l.hljsStyle||"default",t=l.hljsUrl||"https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.8.0/build/";"complete"===d.readyState?z():e.addEventListener("load",z);e.hljsLoader={disconnect:()=>{f&&f.disconnect();k=""},highlightBlocks:p,observe:a=>{k=a;q()}}}})(window,document);
